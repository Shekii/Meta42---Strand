	<div class="container">
		<div class="row">
			<div class="col-xs-12">
				...
				<p>Share to many different places with Strand and we make sure your posts look great everywhere. Click the 'Connect' buttons below to begin connecting your account to Strand:</p>
			</div>
		</div>
		...
		<div class="row spacer">
			<div class="col-xs-2">
				<div class="row centered">
					...
					<div>
						<span class="fa fa-twitter fa-5x twitter"></span>
					</div>
					<div>
			...
			<div class="col-xs-2">
				<div class="row centered">
					...
					<div>
						<span class="fa fa-facebook fa-5x facebook"></span>
					</div>
					<div>
			...
			<div class="col-xs-2">
				...
				<!--	<a href="<?php echo BASE_URL;?>connect/google"> -->
					<div>
						<span class="fa fa-google-plus fa-5x google-plus"></span>
					</div>
					<div>
			...
			<div class="col-xs-2">
				...
				<!--	<a href="<?php echo BASE_URL;?>connect/google"> -->
					<div>
						<span class="fa fa-tumblr fa-5x tumblr"></span>
					</div>
					<div>
						<p class="tumblr">tumblr</p>
					</div>
					<div>
						<span class="btn btn-default btn-info">Connect</span>
					</div>
